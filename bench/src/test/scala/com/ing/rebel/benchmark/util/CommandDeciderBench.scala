...
import com.ing.rebel.sync.pathsensitive.{DynamicPsacCommandDecider, StaticCommandDecider, TwoPCCommandDecider}
...
class CommandDeciderBench {
  ...
  val lockingDecider: TwoPCCommandDecider[Account.type] = new TwoPCCommandDecider(Account.Logic)
