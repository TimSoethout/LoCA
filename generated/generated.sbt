...
dockerBaseImage := "adoptopenjdk/openjdk11" // Docker image to use as a base for the application image
...
//dockerCommands := dockerCommands.value.patch(3, Seq(Cmd("VOLUME", "/opt/docker/jfr")), 0)
dockerCommands ++= Seq(
